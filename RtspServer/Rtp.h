...
void createRtpSocket(int *serverFD, struct sockaddr_in *addrClient);
...
void RtpEncoder(int sockFD, struct sockaddr_in addrClient, char *FrameStartCode, int FrameLength, int *SequenceNumber, unsigned int *timestamp);
